      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-slate-900">{metrics.totalStores}</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-slate-900">{metrics.totalRatings}</p>
          </div>
        </div>
      </div>

      <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
        <h3 className="text-xl font-bold text-slate-800 mb-4">Welcome to the Administration Panel</h3>
